...
本项目现在提供了一个**完整的自动化工作流程**，专为批量爬取上市公司董事长相关微博而设计：

- ✅ 从Excel读取董事长任职信息
- ✅ 自动按年份（2019-2023）展开为公司-年度组合
- ✅ 批量爬取"公司名称+董事长姓名"关键词的微博
- ✅ 每个公司-年度保留前5条微博（可配置）
- ✅ 结果与原始数据合并输出为Excel/CSV

**快速开始**: [5步快速使用指南](QUICKSTART.md) | [完整文档](WORKFLOW_GUIDE.md)

```bash
# 1. 安装依赖
pip install -r requirements.txt

# 2. 配置Cookie（参见QUICKSTART.md）
